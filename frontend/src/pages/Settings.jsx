...
function SettingsPage() {
  ...
  return (
    <main className="h-screen bg-white dark:bg-slate-800 flex flex-col justify-evenly items-center">
      <div>
        <div className="relative w-full flex flex-col items-center">
          ...
          {/* Modal za cropovanje */}
          {isModalOpen && (
            <div className="modal fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-[100]">
        ...
        <div
          className={`mt-4 text-center w-full flex flex-col items-center ${
            isEditing ? "gap-y-3" : "gap-y-2"
          }`}
        >
          {isEditing ? (
            <input
      ...
      <Footer activePage="settings" isModalOpen={isModalOpen} />
    </main>
  );
}

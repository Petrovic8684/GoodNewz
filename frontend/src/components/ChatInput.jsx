...
function ChatInput({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-transparent shadow-lg">
      <div className="flex flex-col min-h-[65px] sm:min-h-[75px] flex justify-center items-center p-2 sm:p-4">
        {replyToMessage && (
